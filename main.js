...
document.addEventListener("DOMContentLoaded", () => {
  ...
  app.innerHTML = `
    ...
    <select id="posizione" onchange="aggiornaDisegno()">
      ...
      <option value="laterale-sinistro">Laterale Sinistro</option>
    </select>
...
function aggiornaDisegno() {
  ...
  const path = modello + "-" + posizione + ".svg";
  const box = document.getElementById("disegno-tecnico");
  box.innerHTML = `<embed src="${path}" type="image/svg+xml" />`;
}
